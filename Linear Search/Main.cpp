...
//Линейный поиск первого вхождения элемента key в массива arr с длинной length, начиная с позиции begin (по умолчанию - 0)
template <typename T>
...
//Линейный поиск последнего вхождения элемента key в массив arr с длинной length, с позиции begin
template <typename T>
